...
export interface PopupsModel {
  ...
  setIsAuctionsModalOpen: Action<PopupsModel, boolean>;
...
const popupsModel: PopupsModel = {
  ...
  setIsAuctionsModalOpen: action((state, payload) => {
    state.isAuctionsModalOpen = payload;
  }),
