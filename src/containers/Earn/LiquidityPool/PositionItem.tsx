...
import { useMappedTokens, useToken } from '../../../hooks/Tokens'
...
const PositionsItem = ({ positionDetails }: PositionListItemProps) => {
    ...
    const { priceLower, priceUpper, quote, base } =
        getPriceOrderingFromPositionForUI(position, tokens)
    ...
    const positionSummaryLink = '/earn/pool/' + positionDetails.tokenId
